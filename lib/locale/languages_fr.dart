...
class LanguageFr extends BaseLanguage {
  ...
  @override
  String get lblAlertBooking => "Voulez-vous vraiment réserver ce service";
  ...
  String get walkThrough1 =>
      'Inscrivez-vous ou connectez-vous à votre compte en utilisant votre courrier électronique ou vos profils de réseaux sociaux. Remplir votre profil garantit une expérience de réservation fluide.';
  ...
  String get walkThrough3 =>
      "Gardez une trace de l'état de votre service en temps réel. Consultez et gérez vos réservations actuelles et passées. Reprogrammez ou annulez les services à venir sans effort.";
  ...
  @override
  String get lblConfirmReviewSubTitle => "Êtes-vous sûr de vouloir supprimer cet avis?";

  @override
  String get lblConfirmService => "Êtes-vous sûr de vouloir tenir ce service?";

  @override
  String get lblConFirmResumeService => "Êtes-vous sûr de vouloir reprendre ce service?";
  ...
  @override
  String get lblDeleteRatingMsg => "Êtes-vous sûr de vouloir supprimer cette note?";
  ...
  @override
  String get lblDeleteSunTitle => "Êtes-vous sûr de vouloir supprimer cette adresse?";
  ...
  @override
  String get confirmationRequestTxt => "Êtes-vous sûr de vouloir effectuer cette action?";
  ...
  @override
  String get lblAreYouSureWant => 'Êtes-vous sûr de vouloir';
  ...
  @override
  String get areYouSureWantToRemoveThisFile => 'Êtes-vous sûr de vouloir supprimer ce fichier?';
  ...
  @override
  String get deleteBankTitle => 'Etes-vous sûr de vouloir supprimer cette banque ?';
